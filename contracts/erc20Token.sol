...
contract ERC20Token is ERC20Interface {
    ...
    uint256 private _totSupply;             // Total number of tokens
    ...
    constructor(
        ...
        _balances[msg.sender] = _initialAmount;               // The creator owns all initial tokens
        _totSupply = _initialAmount;                        // Update total token supply
    ...
    function transfer(address _to, uint256 _value) public returns (bool success) {
        require(_balances[msg.sender] >= _value,"Insufficient funds for transfer source.");
    ...
    function transferFrom(address _from, address _to, uint256 _value) public returns (bool success) {
        require(_balances[_from] >= _value && _allowed[_from][msg.sender] >= _value,"Insufficient allowed funds for transfer source.");
        require(_to != address(0));
        _balances[_to] += _value;
        _balances[_from] -= _value;
        if (_allowed[_from][msg.sender] < MAX_UINT256) {
